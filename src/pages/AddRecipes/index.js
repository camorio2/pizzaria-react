...
export const AddRecipesUser = () => {
    ...
    const HandleAddRecipe = () => {
        clicked ? setClicked('') : setClicked('itens oculta');
    };
    return (
        <>
