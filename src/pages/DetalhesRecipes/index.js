      ...
      <div className="detalhes">
        ...
        <div className="GropoB">
          <div className="GropoAB">
            ...
            <p className="ABC">{recipeData?.description}</p>
            <div className="ABCD">
          ...
          <div className="roatape">
            ...
            <p className="bbb">Adicionar Nas Minhas Receitas</p>
            <p className="bbb">Marcar Para Fazer Esta Receita</p>
            <p className="bbb">Seguir Este Usúario e Suas Postagens</p>
            <p className="bbbs">Denunciar Usuario, Postagens</p>
            <p className="bbbs">Enviar Uma Reclamação</p>
          </div>
        </div>
      </div>
    </div>
